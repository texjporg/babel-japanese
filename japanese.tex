...
insert a quarter em space (\emph{shibu aki}) automatically, so
...
[TODO] どうする？（ソース中のコメント参照）
% LuaLaTeX: \usepackage[deluxe]{luatexja-preset}
%  * 多書体化は luatexja-otf でないことに注意
% (u)pLaTeX + jlreq: \usepackage{jlreq-deluxe}
% (u)pLaTeX + j(s)classes: \usepackage[deluxe]{otf}
...
Using \LuaLaTeX:\footnote{Sinve \Pkg{hyperref} 2020-08-14 v7.00f,
...
\begin{lstlisting}
  ...
  \renewcommand{\kanjifamilydefault}{\gtdefault}% san-serif also for Japanese
